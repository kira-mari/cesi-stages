...
-- 6-14. Étudiants (Ahmed, Paul, Lionel, Lilian, Mohamed, Lucas, Enzo, Saleh, Victor)
...
(1, 6, 'Votre offre correspond exactement à mes compétences.', 'en_attente'), -- Ahmed -> Capgemini
(4, 8, 'Passionné par la data, je veux rejoindre Criteo.', 'acceptee'),     -- Lionel -> Criteo
(8, 9, 'DevOps est mon avenir, je suis super motivé.', 'refusee'),       -- Lilian -> OVH
(10, 7, 'La sécu c''est ma vie.', 'en_attente'),                        -- Paul -> Thales
(12, 11, 'Je veux créer des jeux chez vous !', 'en_attente'),            -- Lucas -> Ubisoft
(15, 12, 'L''aérospatial me fait rêver.', 'en_attente'),                 -- Enzo -> Airbus
(5, 13, 'Le machine learning m''intéresse beaucoup.', 'acceptee');       -- Saleh -> Criteo
...
(1, 6, 5, 'Super ambiance chez Capgemini, j''ai beaucoup appris sur React. Les tuteurs sont très pédagogues et l''équipe est jeune.', '2024-09-15 10:00:00'),
(1, 8, 4, 'Bonne expérience globale, mais beaucoup de travail. Le salaire est correct pour le marché.', '2024-10-02 14:30:00'),
(2, 7, 5, 'Incroyable stage chez Criteo. Les locaux sont magnifiques (salle de sport, cantine bio) et les projets data sont passionnants.', '2024-08-20 09:15:00'),
(3, 11, 3, 'Un peu déçu par le management chez Publicis, mais les missions étaient intéressantes graphiquement.', '2024-11-05 16:45:00'),
(4, 9, 5, 'OVHcloud c''est le top pour apprendre le Cloud et le DevOps. On nous donne de vraies responsabilités dès le début.', '2024-12-01 11:20:00'),
(6, 11, 5, 'Travailler sur un AAA chez Ubisoft c''était mon rêve. Pression intense en fin de projet (crunch) mais super fier du résultat.', '2024-07-30 18:00:00'),
(5, 10, 4, 'Thales est une école de rigueur. Très formateur pour la cybersécurité, même si les process sont un peu lourds.', '2024-09-10 13:40:00'),
(8, 12, 5, 'Airbus offre un cadre de travail exceptionnel à Toulouse. Projets internationaux et technos de pointe.', '2024-10-15 08:50:00'),
(11, 13, 4, 'Stage très terrain chez Michelin, j''ai adoré voir les lignes de production. L''équipe industrie 4.0 est top.', '2025-01-10 15:30:00'),
(13, 14, 2, 'Stage un peu répétitif chez Orange sur le déploiement fibre, mais bonne ambiance dans l''équipe technique.', '2024-11-20 10:10:00');

-- ============================================
-- Insertion des Assignations Pilotes-Etudiants
-- ============================================
-- Smail (2) suit Ahmed (6), Mohamed (10), Victor (14)
INSERT INTO pilote_etudiant (pilote_id, etudiant_id) VALUES (2, 6), (2, 10), (2, 14);

-- Myriam (3) suit Paul (7), Lucas (11)
INSERT INTO pilote_etudiant (pilote_id, etudiant_id) VALUES (3, 7), (3, 11);

-- Rim (4) suit Lionel (8), Enzo (12)
INSERT INTO pilote_etudiant (pilote_id, etudiant_id) VALUES (4, 8), (4, 12);

-- Sonia (5) suit Lilian (9), Saleh (13)
INSERT INTO pilote_etudiant (pilote_id, etudiant_id) VALUES (5, 9), (5, 13);
